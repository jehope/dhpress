  ...
  <?php
    ...
    $args = array(
        ...
        foreach ( $posts as $post ) {
            ...
            $meta_classification = get_post_meta( $post->ID, 'diph_map_classification', true );
            $meta_state = get_post_meta( $post->ID, 'diph_map_state', true );
            $meta_county = get_post_meta( $post->ID, 'diph_map_county', true );
            $meta_city = get_post_meta( $post->ID, 'diph_map_city', true );
            $meta_year = get_post_meta( $post->ID, 'diph_map_year', true );
